...
function _PlaceholderadsInit() {
  ...
  let wwadsDiv =
    '<div class="wwads-cn wwads-horizontal" data-id="159" style="z-index: 10;position: fixed;top: 130px;right: 10px;max-width: 200px;padding: 10px;border-radius: 5px;"></div>';
