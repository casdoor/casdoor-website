...
1. Casdoor uses OAuth 2.0 for authorization. For a short intro to OAuth 2.0, see [An introduction to OAuth 2](https://www.digitalocean.com/community/tutorials/an-introduction-to-oauth-2).
