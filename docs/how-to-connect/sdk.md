...
SDK: `casdoor-js-sdk` or React SDK: `casdoor-react-sdk` or Vue SDK: `casdoor-vue-sdk` to integrate Casdoor in frontend. If your web application is a
...
| .NET Desktop SDK | For .NET desktop apps         |                                                                       | WPF: [casdoor-dotnet-desktop-example](https://github.com/casdoor/casdoor-dotnet-desktop-example), WinForms: [casdoor-dotnet-winform-example](https://github.com/casdoor/casdoor-dotnet-winform-example) |
| React SDK        | For React websites            | [casdoor-react-sdk](https://github.com/casdoor/casdoor-react-sdk)     |                                                                                                                                                                                                         |
