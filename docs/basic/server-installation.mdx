...
- Set Proxy:
  ...
  The first method, by configuring [**conf/app.conf**](https://github.com/casdoor/casdoor/blob/master/conf/app.conf):
  
  ```ini
  socks5Proxy = "127.0.0.1:10808"
  ```

  The second method, When building, you can specify parameters：
