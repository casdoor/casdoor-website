...
The full reference of `Casdoor Public API` can be viewed at Swagger: [**https://door.casbin.com/swagger**](https://door.casbin.com/swagger) . This Swagger docs are automatically generated by Beego's Bee tool.
