...
description: Runnable code examples for MCP servers using Casdoor OAuth (Python, Node.js, Go).
keywords: [MCP, integration, Python, Node.js, Go, JWT, JWKS]
authors: [hsluoyz]
---
...
- Casdoor with an MCP application ([Setup](./setup.md))
